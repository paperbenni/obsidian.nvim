...
require("obsidian").setup {
  ...
  -- Configure how external files are opened.
  -- The 'open' table allows you to specify advanced options for opening files.
  ...
  open = {
    ...
    -- Function to open files, defaults to vim.ui.open
    func = vim.ui.open,
    -- Optionally, you can specify file types to be opened externally.
    -- Example:
